  ...
  try {
    ...
    if (hasDatabase) {
      ...
      bookingData = {
        ...
        customerPhone: (booking as any).userPhone || "9523765172",
        kycStatus: (booking as any).kycStatus || "unverified",
        isKycVerified: (booking as any).isKycVerified || false,
        kycExpiresAt: (booking as any).kycExpiresAt || null,
        drivingLicenseUrl: (booking as any).drivingLicenseUrl || null,
        aadhaarFrontUrl: (booking as any).aadhaarFrontUrl || null,
        aadhaarBackUrl: (booking as any).aadhaarBackUrl || null,
        drivingLicenseNo: (booking as any).drivingLicenseNo || null,
        governmentIdNo: (booking as any).governmentIdNo || null,
        vehicleTitle: vehicle.title,
