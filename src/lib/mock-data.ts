...
// Generate cityConfigs from the comprehensive India cities database
const generateCityConfigs = () => {
  const configs: CityConfig[] = [];
  
  Object.entries(indiaCitiesByState).forEach(([state, cities]) => {
    // Get unique cities for this state and sort them
    const uniqueCities = Array.from(new Set(cities)) as string[];
    uniqueCities.forEach((city) => {
      configs.push({
        name: `${city}, ${state}`,
        airport: "", // Can be updated with specific airport data
      });
    });
  });
...
export const cityConfigs: CityConfig[] = generateCityConfigs();
...
export const bookingAddOns: BookingAddOn[] = [
  ...
  // Bike-specific protective gear
  { id: "jacket", label: "Riding Jacket", pricePerDayINR: 150, pricePerHourINR: 15 },
  { id: "gloves", label: "Riding Gloves", pricePerDayINR: 50, pricePerHourINR: 5 },
  { id: "guards", label: "Knee & Elbow Guards", pricePerDayINR: 80, pricePerHourINR: 8 },
  // Bike touring utilities
  { id: "mount", label: "GPS Phone Mount", pricePerDayINR: 30, pricePerHourINR: 3 },
  { id: "saddlebags", label: "Saddle Bags", pricePerDayINR: 120, pricePerHourINR: 12 },
  { id: "cam-mount", label: "Action Camera Mount", pricePerDayINR: 40, pricePerHourINR: 4 },
  // Car / camping / outdoor gear
  { id: "tent", label: "Camping Tent", pricePerDayINR: 250, pricePerHourINR: 25 },
  { id: "sleeping-bag", label: "Warm Sleeping Bag", pricePerDayINR: 90, pricePerHourINR: 9 },
  { id: "camp-set", label: "Camping Table & Chairs", pricePerDayINR: 150, pricePerHourINR: 15 },
  { id: "carrier", label: "Rooftop Luggage Carrier", pricePerDayINR: 200, pricePerHourINR: 20 },
  { id: "cooler", label: "Portable Cooler Box", pricePerDayINR: 100, pricePerHourINR: 10 },
];
...
export const vehicles: Vehicle[] = [
  ...
  {
    id: "veh-2",
    title: "Royal Enfield Classic 350 (⚡ ₹1 Test Ride)",
    city: "Delhi",
    type: "bike",
    fuel: "petrol",
    transmission: "manual",
